...
Last updated: 2026-07-29 · Production: **v2.5.680** (`514cdcb8`).
...
|---|-------|-------|-------|--------|
| _next_ | (Ember to define the next visual slice against the reference, within §2) | Ember → GreenBear gate | TBD | PLANNED |
