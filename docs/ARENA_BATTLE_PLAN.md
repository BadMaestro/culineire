...
Last updated: 2026-07-29 · Production: **v2.5.684** (`c125b6ff`). Target: **v2.5.685**.
...
| 3 | Restore the approved bevelled plinth silhouette and brass edge to the always-visible rank labels; no floor, camera or mechanism changes | Ember temporary full gate | `static/css/arena_deck_polish.css`, `templates/chef_battle/arena.html`, `chef_battle/tests.py`, `recipes/views.py` | READY v2.5.685 |
