...
class GenerateRecipeCommandTests(TestCase):
    ...
    def test_generate_recipe_creates_draft_only_with_safety_fields(self, call_anthropic):
        ...
        self.assertIn("commissioned by CulinEire", recipe.source_note)
        self.assertIn("owned by CulinEire", recipe.source_note)
        self.assertIn("Unauthorised copying", recipe.source_note)
        self.assertIn("free reuse of this content is not permitted", recipe.source_note)
        self.assertIn("copy or print this recipe for personal use", recipe.source_note)
        self.assertIn("leave a rating", recipe.source_note)
        self.assertIn("write a comment", recipe.source_note)
        self.assertIn("cup of coffee", recipe.source_note)
