    ...
    },
    {
        ...
        "workstreams": [
            ...
            {"id": "3G", "title": "Visual integration (composition redesign)", "owner": "Cursor (composition/polish); ArenaFront (atmosphere assets)",
             "status": "IN PROGRESS — ATMOSPHERE af9 OUTER HAZE + CURSOR POLISH",
             ...
             "evidence": "R0/R1 done. af6 live (Cursor tip b68da937 / v2.5.474). ArenaFront af7–af9 on branch (journal renumbered 475–477 after collision); outer stand haze + gold dust; SVG centre clear. D2/D3 open. 8:6:1 NOT claimed.",
