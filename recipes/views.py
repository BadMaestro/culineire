    ...
    },
    {
        ...
        "workstreams": [
            ...
            {"id": "3G", "title": "Visual integration (composition redesign)", "owner": "Cursor (composition/polish); ArenaFront (atmosphere assets)",
             "status": "IN PROGRESS — ATMOSPHERE af17 GOLD BLOOM + CURSOR POLISH",
             ...
             "evidence": "R0/R1 done. af6–af14 live (wall-wash). ArenaFront af15–af17 pending (dust, read-through, gold bloom); SVG centre clear. Dual-cursor: one merger. D2/D3 open. 8:6:1 NOT claimed.",
