    ...
    },
    {
        ...
        "workstreams": [
            ...
            {"id": "3G", "title": "Visual integration (composition redesign)", "owner": "Cursor (composition/polish); ArenaFront (atmosphere assets)",
             "status": "IN PROGRESS — r10c + af5–af8 (v2.5.476)",
             ...
             "evidence": "R0/R1 done. Cursor r10c. ArenaFront af5 dark hall; af6 SVG-clear; af7 token deepen/no HEX; af8 (a2e97a39) denser side gold dust. Load order polish r10c → atmosphere af8 (v2.5.476). fitScene preserved. Fence held. D2/D3 open. 8:6:1 NOT claimed.",
