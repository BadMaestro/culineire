    ...
    },
    {
        ...
        "workstreams": [
            ...
            {"id": "3G", "title": "Visual integration (composition redesign)", "owner": "Cursor (composition/polish); ArenaFront (atmosphere assets)",
             "status": "IN PROGRESS — ATMOSPHERE af7 TOKEN HALL + CURSOR POLISH",
             ...
             "evidence": "R0/R1 done. Cursor polish continuous (r10c; af5+r10c merge/deploy path). ArenaFront af6 SVG-clear floor; af7 drops raw HEX fallback, deepens gold bloom + side washes with --hall-* only; centre mask held. D2/D3 open. 8:6:1 NOT claimed.",
