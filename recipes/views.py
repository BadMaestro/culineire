    ...
    },
    {
        ...
        "workstreams": [
            ...
            {"id": "3G", "title": "Visual integration (composition redesign)", "owner": "Cursor (composition/polish); ArenaFront (atmosphere assets)",
             "status": "IN PROGRESS — R0/R1/R3/R4/R6/CF5/3C done; MOCKUP_OCTAGON_OVAL; R5/D2 open; af STOPPED",
             ...
             "evidence": "R0/R1/R3/R4/R6/CF5/3C done. MOCKUP_OCTAGON_OVAL: chef rings 9..40 + spectator oval cap 290 (FE ff141240). R4 v2.5.560. Capacity honesty 544→290 (Owner geometry). R5/D2 still open. AF STOPPED. D3 open.",
            ...
            {"id": "3I", "title": "Crowd assets: real faces in real seats (A2/A3/G6)", "owner": "ArenaFront (generation); Cursor (compositing); Bolt (acceptance)",
             "status": "IN PROGRESS — A2 done and Owner-approved; A3 (96 with head rotation) and G6 (faces into seats) running",
