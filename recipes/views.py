...
ARENA_DESIGN_TASKS = [
    ...
    {
        "id": "T23", "group": "Chef Battles roadmap (Owner list, 2026-08-16)", "title": "Clan and team battles",
        ...
        "evidence": "CREATED 2026-08-16 on the Owner's instruction (list item 2), assigned to Bolt.",
    },
    {
...
ARENA_RELEASE_STAGES = [
    ...
    },
    {
        ...
        "commit": "a663ba34 / production v2.5.1119",
