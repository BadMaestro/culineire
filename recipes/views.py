    ...
    },
    {
        ...
        "workstreams": [
            ...
            {"id": "3G", "title": "Visual integration (composition redesign)", "owner": "Cursor (composition/polish); ArenaFront (atmosphere assets)",
             "status": "IN PROGRESS — r10c + af5/af6 (v2.5.474)",
             ...
             "evidence": "R0/R1 done. Cursor r10c transparent confrontation + SVG contrast. ArenaFront af5 dark hall after polish; af6 (7a2e1d9d) centre floor-sheen dialed down/masked so live SVG seats read. Load order polish r10c → atmosphere af6 (v2.5.474). fitScene preserved. Fence held. D2/D3 open. 8:6:1 NOT claimed.",
