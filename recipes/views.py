    ...
    },
    {
        ...
        "workstreams": [
            ...
            {"id": "3G", "title": "Visual integration (composition redesign)", "owner": "Cursor (composition/polish); ArenaFront (atmosphere assets)",
             "status": "IN PROGRESS — ATMOSPHERE af8 GOLD DUST + CURSOR POLISH",
             ...
             "evidence": "R0/R1 done. Cursor polish continuous (r10c; af5+r10c merge/deploy path). ArenaFront af6–af7 on branch; af8 denser side gold dust + stand gold lines; SVG centre mask held. D2/D3 open. 8:6:1 NOT claimed.",
