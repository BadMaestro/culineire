...
def _build_amuse_bouche_roadmap_status():
    phases = [
        ...
        },
        {
            ...
            "title": "Activity Feed",
            "status": "done",
            "summary": "Newsfeed event types, signals and presentation styles are complete.",
            "done": [
                "Added Amuse-Bouche newsfeed event types (published + featured).",
                "Signal creates/hides publication events on approve/unapprove.",
                "Improved signal copy: title is the bite title, message includes author name.",
                "Added amuse_bouche_published and amuse_bouche_featured dot + badge CSS to newsfeed.css.",
            ],
            "current": [],
            "remaining": [],
            "files": ["newsfeed/models.py", "amuse_bouche/signals.py", "static/css/newsfeed.css"],
        },
        {
            "id": "phase-6",
            "phase": "Phase 6",
            ...
            "status": "done",
            "summary": "Navigation, homepage block and profile hooks are fully wired to AMUSE_BOUCHE_PUBLIC gate.",
            "done": [
                "Main nav Amuse-Bouche link now uses can_view_amuse_bouche_public_area context var.",
                "Homepage block gated behind the same visibility flag.",
                "Author profile counts/dashboard rows and My Collection tab all gated.",
                "Nav link auto-shows when AMUSE_BOUCHE_PUBLIC=True is set in .env.",
            ],
            "current": [],
            "remaining": [],
        ...
        },
        {
            ...
            "status": "done",
            "summary": "One-click generation from approved recipes and articles is live.",
            "done": [
                "Added generate_from_recipe and generate_from_article POST endpoints.",
                "Enforced one-bite-per-source-per-author deduplication (excluding archived).",
                "Pre-fills title, excerpt/short_description, cover_image_alt and linked source from the origin.",
                "Added Generate Amuse-Bouche button to recipe detail hero (author/moderator only, approved only).",
                "Added Generate Amuse-Bouche button to article detail (author/moderator only, approved only).",
                "Button switches to View Amuse-Bouche when a bite already exists for that source.",
            ],
            "current": [],
            "remaining": [],
            "files": ["amuse_bouche/views.py", "amuse_bouche/urls.py", "recipes/views.py", "articles/views.py", "templates/recipes/recipe_detail.html", "templates/articles/article_detail.html"],
        },
        {
            "id": "phase-8",
            "phase": "Phase 8",
        ...
        },
        {
            ...
            "title": "Public Launch",
            "status": "done",
            "summary": "Amuse-Bouche is released publicly by default, with AMUSE_BOUCHE_PUBLIC=False retained as a kill switch.",
            "done": [
                ...
                "Set AMUSE_BOUCHE_PUBLIC default to True for public release.",
                "Verified public feed/detail/home link smoke checks with AMUSE_BOUCHE_PUBLIC=True.",
                "Retained AMUSE_BOUCHE_PUBLIC=False as an emergency hide switch.",
            ],
            "current": [],
            "remaining": [
            ...
            "files": ["config/settings.py", "templates/base.html", "templates/home.html", "static/css/amuse_bouche.css", "recipes/views.py"],
        },
        {
            "id": "phase-12",
            "phase": "Phase 12",
    ...
    return {
        ...
        "progress_scope": "MVP release complete. Amuse-Bouche is public by default; use AMUSE_BOUCHE_PUBLIC=False only as an emergency hide switch.",
