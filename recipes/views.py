...
ARENA_DESIGN_TASKS = [
    ...
    },
    {
        ...
        "evidence": "Owner ruling 2026-08-15: both chefs set 2 blocks before the battle to protect key recipe ingredients; only the Stage 1 winner receives 3 shots; the loser does not shoot and only defends. This supersedes the old two-48-hour-window wording.",
    },
    {
