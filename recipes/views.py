    ...
    },
    {
        ...
        "workstreams": [
            ...
            {"id": "3G", "title": "Visual integration (composition redesign)", "owner": "Cursor (composition/polish); ArenaFront (atmosphere assets)",
             "status": "IN PROGRESS — ATMOSPHERE af18 STAND GOLD + CURSOR POLISH",
             ...
             "evidence": "R0/R1 done. af6–af14 live. ArenaFront af15–af18 pending (dust, read-through, gold bloom, stand rails); SVG centre clear. Dual-cursor: one merger. D2/D3 open. 8:6:1 NOT claimed.",
