...
ARENA_DESIGN_TASKS = [
    ...
    },
    {
        ...
        "evidence": "CREATED 2026-08-16 on the Owner's instruction, by Bolt, who did not take it. The contract is recorded in ARENA_BATTLE_PLAN.md from the T18 release: GreenBear may appear and join clans/alliances cosmetically, adds only a clan reputation blessing, and must be excluded from challenges, battles and every competitive aggregate; T18 deliberately did not claim it and the board said to record it separately rather than expand T18. The three gaps above were read out of the code on 2026-08-16 and are cited with their call sites. NOT VERIFIED, and stated so rather than assumed: whether a challenge naming the Owner would survive the rest of accept_challenge's gates (rank matchup, slot, age) was not tested - only that he appears in the selection queryset. Nothing was touched on his account to find any of this.",
    },
    {
...
ARENA_RELEASE_STAGES = [
    ...
    },
    {
        ...
        "commit": "4dc7b83b / production v2.5.1110",
