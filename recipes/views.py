    ...
    },
    {
        ...
        "workstreams": [
            ...
            {"id": "3G", "title": "Visual integration (composition redesign)", "owner": "Cursor (composition/polish); ArenaFront (atmosphere assets)",
             "status": "IN PROGRESS — R0/R1/R3/R6/CF5/3C done; R4 D1=B STARTING; af atmosphere STOPPED",
             ...
             "evidence": "R0/R1/R3/R6/CF5/3C done (3C v2.5.559). Owner D1 2026-07-24 Option B: redo GreenBear side-column recommendation — FE agent/arenafront/r4-rank-centred-stack (Ember centred rank stack, official tokens). R5 still blocked on D2. AF atmosphere STOPPED. D3 open. 8:6:1 NOT claimed.",
