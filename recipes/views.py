    ...
    },
    {
        ...
        "workstreams": [
            ...
            {"id": "3G", "title": "Visual integration (composition redesign)", "owner": "Cursor (composition/polish); ArenaFront (atmosphere assets)",
             "status": "IN PROGRESS — ATMOSPHERE af6 SVG-CLEAR FLOOR + CURSOR POLISH",
             ...
             "evidence": "R0/R1 done. Cursor polish continuous (r10c SVG contrast). ArenaFront af5 dark hall after polish; af6 (Owner #2207) dials down centre floor-sheen/mask so live SVG seat rings remain readable; wall wash kept. D2/D3 open. 8:6:1 NOT claimed.",
