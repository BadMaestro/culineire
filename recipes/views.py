    ...
    },
    {
        ...
        "workstreams": [
            ...
            {"id": "3G", "title": "Visual integration (composition redesign)", "owner": "Cursor (composition/polish); ArenaFront (atmosphere assets)",
             "status": "IN PROGRESS — r10c + af5–af12 (v2.5.478)",
             ...
             "evidence": "R0/R1 done. Cursor r10c. ArenaFront af5–af10 live; af11 side washes (5b5b7421); af12 bottom depth (c7940285). Load order polish r10c → atmosphere af12 (v2.5.478). fitScene preserved. Fence held. D2/D3 open. 8:6:1 NOT claimed.",
