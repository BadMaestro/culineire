    ...
    },
    {
        ...
        "workstreams": [
            ...
            {"id": "3G", "title": "Visual integration (composition redesign)", "owner": "Cursor (composition/polish); ArenaFront (atmosphere assets)",
             "status": "IN PROGRESS — ATMOSPHERE af5 DARK HALL PAGE FILL + CURSOR POLISH",
             ...
             "evidence": "R0/R1 done. Cursor continuous polish. ArenaFront: af3 merged; af4 crowd-haze; af5 (Owner Capture10) moves atmosphere AFTER polish and reclaims dark hall .page--arena fill so mockup cinematic walls read outside the parchment floor — polish deck chrome untouched. D2/D3 open. 8:6:1 NOT claimed.",
