    ...
    },
    {
        ...
        "workstreams": [
            ...
            {"id": "3G", "title": "Visual integration (composition redesign)", "owner": "Cursor (composition/polish); ArenaFront (atmosphere assets)",
             "status": "IN PROGRESS — r10c + af5/af6/af7 (v2.5.475)",
             ...
             "evidence": "R0/R1 done. Cursor r10c. ArenaFront af5 dark hall after polish; af6 SVG-clear centre; af7 (dab856e0) token-only hall deepen, HEX fallback removed. Load order polish r10c → atmosphere af7 (v2.5.475). fitScene preserved. Fence held. D2/D3 open. 8:6:1 NOT claimed.",
