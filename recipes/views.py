    ...
    },
    {
        ...
        "workstreams": [
            ...
            {"id": "3G", "title": "Visual integration (composition redesign)", "owner": "Cursor (composition/polish); ArenaFront (atmosphere assets)",
             "status": "IN PROGRESS — LIVE COMPOSITION + ATMOSPHERE UNDERLAY (v2.5.469 / 8cb3d854)",
             ...
             "evidence": "R0 map OWNER_APPROVED. R1 tokens shipped. Live composition grafts on arena_deck_polish.css (ribbon, confrontation/hex chefs, spine, parchment, walls, seat rings, z-stack, dock, glow). Unsquash fix 369965be restored fitScene transform (removed polish rotateX override). ArenaFront atmosphere merged under polish-last: 23542486 → 8cb3d854 (af3). Fence: polish vs atmosphere CSS; shared arena.html coordinated. Prototype branch must never merge. D2/D3 still open. Distributed 8:6:1 NOT claimed for these visual slices.",
