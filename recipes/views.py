...
ARENA_RELEASE_STAGES = [
    ...
    },
    {
        ...
        "owners": "GreenBear (gate) + Owner (approval)",
        "criteria": ["All visual slices in the plan accepted by the Owner.",
        ...
        "blockers": ["Requires all visual slices accepted and explicit Owner release approval."],
        "branch": "Not approved", "commit": "Not approved",
        "verification": "Not started.",
        "updated": "2026-07-29T01:00:00.000Z",
        "next_action": "Wait for Stage 2 completion and Owner release approval.",
    },
]
