    ...
    },
    {
        ...
        "workstreams": [
            ...
            {"id": "3G", "title": "Visual integration (composition redesign)", "owner": "Cursor (composition/polish); ArenaFront (atmosphere assets)",
             "status": "IN PROGRESS — ATMOSPHERE af14 WALL-WASH + CURSOR POLISH",
             ...
             "evidence": "R0/R1 done. af6–af12 live path (Cursor through v2.5.478). ArenaFront af13–af14 pending (corners + regenerated wall-wash); SVG centre clear. D2/D3 open. 8:6:1 NOT claimed.",
