...
ARENA_RELEASE_STAGES = [
    ...
    },
    {
        ...
        "verification": "3A is deployed and distributed verified. 3B is deployed and passed authenticated production re-QA 19/19 within its recorded scope. 3C, 3D, and 3E have partial deployed implementation but remain open. CF5 battle_detail a11y DEPLOYED v2.5.558.",
        ...
        "workstreams": [
            ...
            {"id": "3C", "title": "Real spectator overlay", "owner": "ArenaFront (FE) + Cursor (BE) — 3C pair",
             "status": "IN PROGRESS — FE removing synthetic interactive stand-ins",
             ...
             "evidence": "FE WIP on agent/arenafront/3c-spectator-overlay: arena_render.js fillCrowd no longer paints ARENA_CROWD_FACES into empty interactive spectator polygons (3C contract). Real payload.spectators + self-seat via appendOccupant/markSeatable retained. Atmospheric haze remains non-interactive (arena_atmosphere). Prior baseline 0342760f had live seating but synthetic stand-ins; that gap is the FE close. Awaiting Cursor BE confirm + joint verify.",
            ...
            {"id": "3G", "title": "Visual integration (composition redesign)", "owner": "Cursor (composition/polish); ArenaFront (atmosphere assets)",
             "status": "IN PROGRESS — R0/R1/R3/R6 done; CF5 done; r10c + af5–af82; widget hotfix v2.5.557",
             ...
             "evidence": "R0/R1/R3/R6 done. R3 confrontation band DEPLOYED v2.5.551. R6 phase stepper DEPLOYED v2.5.556 (e5a5097a). Hotfix v2.5.557 (190bd58b): site-battle-widget fixed; CSS BG geometry removed. CF5 battle_detail a11y DEPLOYED v2.5.558 (83b202d9). Next runway blocked on D1/D2 (R4/R5). 3C PARKED. ArenaFront af5–af82 STOPPED. D2/D3 open. 8:6:1 NOT claimed.",
