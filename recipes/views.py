    ...
    },
    {
        ...
        "workstreams": [
            ...
            {"id": "3G", "title": "Visual integration (composition redesign)", "owner": "Cursor (composition/polish); ArenaFront (atmosphere assets)",
             "status": "IN PROGRESS — r10c + af5–af16 (v2.5.485)",
             ...
             "evidence": "R0/R1 done. Cursor r10c. ArenaFront af5–af16 (wall-wash, gold-dust drift, wall read-through). Load order polish r10c → atmosphere af16 (v2.5.485). fitScene preserved. Fence held. D2/D3 open. 8:6:1 NOT claimed.",
