...
ARENA_DESIGN_TASKS = [
    ...
    },
    {
        ...
        "evidence": "State contracts exist; final visual-state coverage pending.",
    },
    {
    ...
    },
    {
        ...
        "acceptance": "His answer recorded verbatim in the release journal, then the losing side corrected.",
        "forbidden": "Do not 'fix' this by editing code to match an archived doc; several of these are money.",
        "evidence": "battle_rules.md specifies battle_deadline = accepted_at + 24h and a 24-hour window covering combat, cooking and submission. Battle has no battle_deadline; accept_challenge() (services.py:174) sets submission_deadline = start_time + 48h and voting_deadline = that + 2 days. The public rules page says 48 hours to submit. The document's auto-cancel has no field to hang on. STRUCTURAL NOTE: the whole Chef Battles design corpus is ARCHIVED, and AGENTS.md section 10 says an archived document cannot define current scope. That is why these drifted, and it is why the fix is a ruling and not a patch.",
    },
    {
        ...
        "acceptance": "His answer recorded verbatim in the release journal, then the losing side corrected.",
        "forbidden": "Do not 'fix' this by editing code to match an archived doc; several of these are money.",
        "evidence": "moves_economy.md: recipe +2, article +2, battle win +5, participation +1. energy_service.py lines 22-27: recipe 5, article 5, win 10, participation 1. The document even carries a 'previous values' table saying recipe went 3 -> 2; the code says 5. STRUCTURAL NOTE: the whole Chef Battles design corpus is ARCHIVED, and AGENTS.md section 10 says an archived document cannot define current scope. That is why these drifted, and it is why the fix is a ruling and not a patch.",
    },
    {
        ...
        "acceptance": "His answer recorded verbatim in the release journal, then the losing side corrected.",
        "forbidden": "Do not 'fix' this by editing code to match an archived doc; several of these are money.",
        "evidence": "moves_economy.md: 1-3 moves per round. services.py:985: COMBAT_MOVES_MAX = 5. STRUCTURAL NOTE: the whole Chef Battles design corpus is ARCHIVED, and AGENTS.md section 10 says an archived document cannot define current scope. That is why these drifted, and it is why the fix is a ruling and not a patch.",
    },
    {
    ...
    },
    {
        ...
        "acceptance": "His answer recorded verbatim in the release journal, then the losing side corrected.",
        "forbidden": "Do not 'fix' this by editing code to match an archived doc; several of these are money.",
        "evidence": "token_economy.md: four packages - Starter 100/EUR10, Popular 250/EUR20, Pro 600/EUR40, Champion 1400/EUR80. Code: the eight in X04. This is money. STRUCTURAL NOTE: the whole Chef Battles design corpus is ARCHIVED, and AGENTS.md section 10 says an archived document cannot define current scope. That is why these drifted, and it is why the fix is a ruling and not a patch.",
    },
    {
...
ARENA_RELEASE_STAGES = [
    ...
    },
    {
        ...
        "commit": "e056745e / production v2.5.956",
