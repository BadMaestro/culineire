    ...
    },
    {
        ...
        "workstreams": [
            ...
            {"id": "3G", "title": "Visual integration (composition redesign)", "owner": "Cursor (composition/polish); ArenaFront (atmosphere assets)",
             "status": "IN PROGRESS — ATMOSPHERE af13 CORNERS + CURSOR POLISH",
             ...
             "evidence": "R0/R1 done. af6–af10 live path (Cursor through v2.5.477). ArenaFront af11–af13 pending (sides, bottom depth, corner vignettes); SVG centre clear. D2/D3 open. 8:6:1 NOT claimed.",
