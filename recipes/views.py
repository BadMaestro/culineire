    ...
    },
    {
        ...
        "workstreams": [
            ...
            {"id": "3G", "title": "Visual integration (composition redesign)", "owner": "Cursor (composition/polish); ArenaFront (atmosphere assets)",
             "status": "IN PROGRESS — ATMOSPHERE af75 LIVE + af76–78 PENDING",
             ...
             "evidence": "R0/R1 done. Pair FE: af75 LIVE (2b70fc19 / v2.5.545). 5-pack DONE af71–af75. Pending af76–af78 tips; SVG centre clear. Telegram 5-pack (#2358). D2/D3 open. 8:6:1 NOT claimed.",
