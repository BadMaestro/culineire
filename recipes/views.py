...
ARENA_RELEASE_STAGES = [
    ...
    },
    {
        ...
        "owners": "3A and 3B deployed; 3C, 3D, and 3E remain open",
        ...
        "blockers": ["3D remains OPEN: owner must select or reject the country/flag data model.",
                     "CF5 remains OPEN and UNASSIGNED; do not close or reinterpret it."],
        ...
        "workstreams": [
            ...
            {"id": "3E", "title": "Rank floor column", "owner": "Unassigned",
             ...
             "evidence": "PARTIAL DEPLOYED IMPLEMENTATION at production baseline 0342760f: all eight rank labels are rendered and positioned over the desktop floor. The workstream remains OPEN because the required >=7:1 numeric contrast artifact is not recorded and the rank column is hidden at widths <=767px, leaving mobile visibility unresolved."},
            ...
            {"id": "3G", "title": "Visual integration (composition redesign)", "owner": "GreenBear (plan); implementation unassigned",
             ...
             "evidence": "Plan recorded in ops/audits/arena_visual_integration_plan.json (base 2fd70161). Reference prototype: branch design/arena-visual-shell-prototype, commit 8ec421c0693ea3199f2d8d566bb8ed7a52d234f5, files confined to ops/prototypes/arena_visual_shell/ — that branch must never be merged into main. Accepted from it: confrontation band (challenger left / Crown Holder centre / opponent right), rails attached to the stage frame, a lower broadcast bar, and a Challenge-to-Crown phase stepper. Rejected: its 37 private tokens, invented logo and icons, the round floor that cannot carry 8 rings of 40/48/56/64/72/80/88/96 seats, the removal of the stands, and placeholder content. Already correct in it and unchanged: Playfair Display and Inter. Slices: R0 correspondence map, R1 tokens, R2 stage frame, R3 confrontation band, R4 rank placement (owner decision), R5 stands and real spectators (owner decision), R6 phase stepper. No implementation has started and no slice may merge to main without the distributed 8:6:1 gate.",
             "blockers": ["D1 rank column: keep the existing side column or adopt the prototype's centred stack.",
                          "D2 stands: keep 544 real seats plus non-impersonating atmosphere, or remove the stands and close 3C as out of scope.",
                          "D4 distributed gate: wake Bolt and Ember for the 8:6:1 run, or issue an explicit written exemption from AGENTS.md section 9 per slice."]},
        ],
    },
    {
