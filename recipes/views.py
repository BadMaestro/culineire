    ...
    },
    {
        ...
        "workstreams": [
            ...
            {"id": "3C", "title": "Real spectator overlay", "owner": "ArenaFront (FE) + Cursor (BE) — 3C pair",
             "status": "DEPLOYED — synthetic interactive stand-ins removed; ArenaSeat stable seats",
             ...
             "evidence": "DEPLOYED v2.5.559. FE tip c809cdfa: fillCrowd no longer paints ARENA_CROWD_FACES into interactive seats; honors ring/cell when present. BE tip e318a76d: ArenaSeat + migration 0084, front-first claim, payload ring/cell/row/is_self, POST /arena/seat/, auto-claim on ping/state. Integrate tip pending journal pin. AF atmosphere STOPPED."},
            ...
            {"id": "3G", "title": "Visual integration (composition redesign)", "owner": "Cursor (composition/polish); ArenaFront (atmosphere assets)",
             "status": "IN PROGRESS — R0/R1/R3/R4/R6/CF5/3C done; R5 blocked D2; af atmosphere STOPPED",
             ...
             "evidence": "R0/R1/R3/R4/R6/CF5/3C done. R4 DEPLOYED v2.5.560 from FE tip 1925d6ad (D1 Option B centred rank stack, official tokens; ArenaRankColumnTests 10/10). R5 still blocked on D2. AF atmosphere STOPPED. D3 open. 8:6:1 NOT claimed.",
