    ...
    },
    {
        ...
        "workstreams": [
            ...
            {"id": "3D", "title": "Chef confrontation panels", "owner": "ArenaFront (FE) + Cursor (BE) — 3R3 pair",
             "status": "CODE READY — 3R3 VERIFIED @ e22acd33 (await Owner merge/deploy)",
             ...
             "evidence": "3R3 VERIFIED pair tip agent/arenafront/3r3-confrontation @ e22acd33 (FE+BE). Contract tests PASS both sides. Holding for Owner-ordered main merge/deploy. AF atmosphere STOPPED. Flag OUT (D3)."},
            ...
            {"id": "3G", "title": "Visual integration (composition redesign)", "owner": "Cursor (composition/polish); ArenaFront (atmosphere assets)",
             "status": "IN PROGRESS — r10c + af5–af82 (v2.5.550)",
             ...
             "evidence": "R0/R1 done. Cursor r10c. ArenaFront af5–af82. Load order polish r10c → atmosphere af82 (v2.5.550). Pair workflow. fitScene preserved. Fence held. D2/D3 open. 8:6:1 NOT claimed.",
