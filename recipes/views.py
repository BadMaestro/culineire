    ...
    },
    {
        ...
        "workstreams": [
            ...
            {"id": "3G", "title": "Visual integration (composition redesign)", "owner": "Cursor (composition/polish); ArenaFront (atmosphere assets)",
             "status": "IN PROGRESS — ATMOSPHERE af10 CEILING + CURSOR POLISH",
             ...
             "evidence": "R0/R1 done. af6–af7 live/deploying (Cursor 474–475). ArenaFront af8–af10 on branch (gold dust, outer haze, ceiling vignette); SVG centre clear. D2/D3 open. 8:6:1 NOT claimed.",
