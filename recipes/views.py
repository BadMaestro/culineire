...
ARENA_DESIGN_TASKS = [
    ...
    },
    {
        ...
        "evidence": "DONE v2.5.689-v2.5.692; complete independent Cooking Widget corrected v2.5.699-v2.5.701.",
    },
    {
        "id": "A06", "group": "Arena Hall", "title": "Fresh production/reference measurement matrix",
        "status": "NEXT", "owner": "Bolt (measurement) + Ember (recording)",
        ...
        "evidence": "Not started. This is the next assignable ticket.",
    },
    {
