    ...
    },
    {
        ...
        "workstreams": [
            ...
            {"id": "3G", "title": "Visual integration (composition redesign)", "owner": "Cursor (composition/polish); ArenaFront (atmosphere assets)",
             "status": "IN PROGRESS — LIVE COMPOSITION r10b (v2.5.471)",
             ...
             "evidence": "R0/R1 done. Live: unsquash 369965be; atmosphere under polish 8cb3d854. r10a (v2.5.470): gold hex VS/crown, parchment plate, ring hierarchy, night-glass panels. r10b (v2.5.471): spine gold ladder, LIVE ribbon weight, chef portrait rings, Join CTA bronze. polish cache 20260724-r10b. fitScene preserved. Fence held. D2/D3 open. 8:6:1 NOT claimed.",
