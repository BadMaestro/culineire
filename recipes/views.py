    ...
    },
    {
        ...
        "workstreams": [
            ...
            {"id": "3G", "title": "Visual integration (composition redesign)", "owner": "Cursor (composition/polish); ArenaFront (atmosphere assets)",
             "status": "IN PROGRESS — ATMOSPHERE af16 WALL READ + CURSOR POLISH",
             ...
             "evidence": "R0/R1 done. af6–af13 live; Cursor auto-merge (one window). ArenaFront af14–af16 (wall-wash, dust drift, wall read-through); SVG centre clear. D2/D3 open. 8:6:1 NOT claimed.",
