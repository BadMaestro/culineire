    ...
    },
    {
        ...
        "workstreams": [
            ...
            {"id": "3G", "title": "Visual integration (composition redesign)", "owner": "Cursor (composition/polish); ArenaFront (atmosphere assets)",
             "status": "IN PROGRESS — r10c + af5 dark hall (v2.5.473)",
             ...
             "evidence": "R0/R1 done. Cursor r10c: transparent confrontation + SVG ring contrast (547fa05a). ArenaFront af4 crowd-haze; af5 (48b03481) atmosphere AFTER polish reclaiming dark .page--arena hall for Owner Capture10. Merged load order: polish r10c then atmosphere af5 (v2.5.473). fitScene preserved. Fence: polish vs atmosphere files. D2/D3 open. 8:6:1 NOT claimed.",
