    ...
    },
    {
        ...
        "workstreams": [
            ...
            {"id": "3G", "title": "Visual integration (composition redesign)", "owner": "Cursor (composition/polish); ArenaFront (atmosphere assets)",
             "status": "IN PROGRESS — R0/R1/R3 done; 3R6 phase stepper integrating; r10c + af5–af82 (v2.5.551)",
             ...
             "evidence": "R0/R1 done. R3 confrontation band DEPLOYED v2.5.551 (e22acd33). 3R6 phase stepper IN INTEGRATE on agent/arenafront/3r6-phase-stepper (BE phase_rail @ 96d8d3e2 + FE SSR/poll/CSS). R4/R5 still owner-gated. Cursor r10c. ArenaFront af5–af82 STOPPED. D2/D3 open. 8:6:1 NOT claimed.",
