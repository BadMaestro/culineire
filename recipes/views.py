    ...
    },
    {
        ...
        "workstreams": [
            ...
            {"id": "3G", "title": "Visual integration (composition redesign)", "owner": "Cursor (composition/polish); ArenaFront (atmosphere assets)",
             "status": "IN PROGRESS — ATMOSPHERE af15 DUST DRIFT + CURSOR POLISH",
             ...
             "evidence": "R0/R1 done. af6–af13 live (Cursor auto-merges atmosphere under Owner no-idle). ArenaFront af14–af15 (wall-wash + gold-dust drift); SVG centre clear. D2/D3 open. 8:6:1 NOT claimed.",
