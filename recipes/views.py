    ...
    },
    {
        ...
        "workstreams": [
            ...
            {"id": "3G", "title": "Visual integration (composition redesign)", "owner": "Cursor (composition/polish); ArenaFront (atmosphere assets)",
             "status": "IN PROGRESS — ATMOSPHERE af23 DUST + CURSOR MERGE",
             ...
             "evidence": "R0/R1 done. af6–af16 live (Cursor tip 861775b0 / v2.5.485). ArenaFront af17–af23 pending designated merger (journal renumbered 486–492); SVG centre clear. D2/D3 open. 8:6:1 NOT claimed.",
