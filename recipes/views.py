...
ARENA_DESIGN_TASKS = [
    ...
    },
    {
        ...
        "status": "DONE", "owner": "Bolt",
        "files": "chef_battle/forms.py (the opponent queryset); chef_battle/selectors.py (get_rankings and every competitive aggregate); the clan reputation blessing, wherever it is built; tests",
        "depends_on": "T18",
    ...
    },
    {
        ...
        "status": "DONE", "owner": "Bolt",
        "files": "static/js/arena_render.js (arena-teleport-flash class already exists at line 2474); static/css/arena.css; the Arena frozen camera architecture (untouched per ARENA_BATTLE_PLAN)",
        ...
        "acceptance": "Not yet defined pending investigation of the existing arena-teleport-flash hook. Does not touch the frozen camera or the octagon region (ARENA_BATTLE_PLAN, THE FROZEN ARCHITECTURE).",
