    ...
    },
    {
        ...
        "workstreams": [
            ...
            {"id": "3G", "title": "Visual integration (composition redesign)", "owner": "Cursor (composition/polish); ArenaFront (atmosphere assets)",
             "status": "IN PROGRESS — ATMOSPHERE af29 DESKTOP HAZE + af28→499",
             ...
             "evidence": "R0/R1 done. Pair FE: af26+af27 LIVE (fb41148f / v2.5.498). af28 tip 6cd5ef36→499 + af29 desktop haze pending merge; SVG centre clear. D2/D3 open. 8:6:1 NOT claimed.",
