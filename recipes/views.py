...
ARENA_DESIGN_TASKS = [
    ...
    },
    {
        ...
        "evidence": "CREATED 2026-08-16 on the Owner's instruction (list item 4), assigned to Bolt - all five list items are his, confirmed explicitly after an earlier conflation with GreenBear's separate F1/F2/F4 frontend plan.",
    },
    {
...
ARENA_RELEASE_STAGES = [
    ...
    },
    {
        ...
        "commit": "8de4acd4 / production v2.5.1117",
