    ...
    },
    {
        ...
        "workstreams": [
            ...
            {"id": "3G", "title": "Visual integration (composition redesign)", "owner": "Cursor (composition/polish); ArenaFront (atmosphere assets)",
             "status": "IN PROGRESS — ATMOSPHERE af65+af66 LIVE + af67–69 PENDING",
             ...
             "evidence": "R0/R1 done. Pair FE: af65+af66 LIVE (a94d23a4 / v2.5.537). 5-pack DONE af61–af65. Pending af67–af69 tips; SVG centre clear. Telegram 5-pack (#2358). D2/D3 open. 8:6:1 NOT claimed.",
