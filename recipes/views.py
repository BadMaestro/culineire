    ...
    },
    {
        ...
        "workstreams": [
            ...
            {"id": "3G", "title": "Visual integration (composition redesign)", "owner": "Cursor (composition/polish); ArenaFront (atmosphere assets)",
             "status": "IN PROGRESS — ATMOSPHERE af34 LIVE + af35–37 PENDING",
             ...
             "evidence": "R0/R1 done. Pair FE: af33+af34 LIVE (0accd4b6 / v2.5.506). Pending af35–af37 tips; SVG centre clear. Telegram 5-pack (#2358). D2/D3 open. 8:6:1 NOT claimed.",
