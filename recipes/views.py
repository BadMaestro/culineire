...
ARENA_RELEASE_STAGES = [
    ...
    },
    {
        ...
        "workstreams": [
            ...
            {"id": "3G", "title": "Visual integration (composition redesign)", "owner": "Cursor (impl); GreenBear (plan)",
             "status": "IN PROGRESS — R0 APPROVED, R1 TOKENS",
             ...
             "evidence": "R0 map OWNER_APPROVED: ops/audits/arena_visual_integration_map.json. R1: challenger/opponent wired to --hall-green/--hall-red; H1 Emerald Hall→Arena Hall; evidence ops/audits/arena_3g_r1_tokens.json. Plan: ops/audits/arena_visual_integration_plan.json. Prototype branch must never merge. D1 resolved Option A (keep side rank column). D2/D3 still open for later slices. Focused ArenaRankColumnTests + R1 token tests; distributed 8:6:1 NOT claimed.",
