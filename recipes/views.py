    ...
    },
    {
        ...
        "workstreams": [
            ...
            {"id": "3G", "title": "Visual integration (composition redesign)", "owner": "Cursor (composition/polish); ArenaFront (atmosphere assets)",
             "status": "IN PROGRESS — ATMOSPHERE af80+af81 LIVE + af82–83 PENDING",
             ...
             "evidence": "R0/R1 done. Pair FE: af80+af81 LIVE (14072cdb / v2.5.549). 5-pack DONE af76–af80. Pending af82–af83 tips; SVG centre clear. Telegram 5-pack (#2358). D2/D3 open. 8:6:1 NOT claimed.",
