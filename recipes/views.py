    ...
    },
    {
        ...
        "workstreams": [
            ...
            {"id": "3G", "title": "Visual integration (composition redesign)", "owner": "Cursor (composition/polish); ArenaFront (atmosphere assets)",
             "status": "IN PROGRESS — ATMOSPHERE af12 DEPTH + CURSOR POLISH",
             ...
             "evidence": "R0/R1 done. af6–af8 live (Cursor 474–476). ArenaFront af9–af12 pending merge (haze, ceiling, sides, bottom depth); SVG centre clear. D2/D3 open. 8:6:1 NOT claimed.",
