    ...
    },
    {
        ...
        "workstreams": [
            ...
            {"id": "3G", "title": "Visual integration (composition redesign)", "owner": "Cursor (composition/polish); ArenaFront (atmosphere assets)",
             "status": "IN PROGRESS — LIVE COMPOSITION + ATMOSPHERE af4 CROWD-HAZE",
             ...
             "evidence": "R0/R1 done. Cursor continuous polish (r10a+). ArenaFront atmosphere: af3 merged 8cb3d854; af4 adds mockup crowd-haze concentric stand underlays (non-interactive; official tokens) on arena_atmosphere.css under polish-last. Fence: polish vs atmosphere. Prototype branch must never merge. D2/D3 open. Distributed 8:6:1 NOT claimed for these visual slices.",
