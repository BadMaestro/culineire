    ...
    phases = [
        ...
        },
        {
            ...
            "items": [
                ...
                {"label": "Add CBR/LSR section to rules", "detail": "Explain: CBR = Chef Battle Rewards, LSR = Live Support Rewards. Both are internal reward records, not tokens, not money until paid out. 11 reward statuses. Winning a battle does not automatically create a payout.", "status": "pending"},
        ...
        },
        {
            ...
            "items": [
                ...
                {"label": "LSR creation on appreciation gift", "detail": "send_appreciation_gift() creates a pending LSR RewardRecord for the sender (10% of gift cost). LedgerEvent LSR_GRANTED written on issue.", "status": "done", "completed_at": "2026-06-14"},
