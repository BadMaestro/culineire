    ...
    phases = [
        ...
        },
        {
            ...
            "items": [
                ...
                {"label": "Challenge flow", "detail": f"Feature built and live. Live: {challenge_count} challenge(s), {pending_challenges} pending, {refused_challenges} refused.", "status": "done"},
                {"label": "Battle room", "detail": f"Feature built and live. Live: {battle_count} battle(s), {active_battles} active, {completed_battles} completed.", "status": "done"},
                {"label": "Recipe submissions", "detail": f"Feature built and live. Live: {entry_count} battle(s) with at least one entry.", "status": "done"},
                {"label": "Public voting", "detail": f"Feature built and live. Live: {vote_count} vote(s) recorded. One vote per battle per session.", "status": "done"},
        ...
        },
        {
            ...
            "items": [
                {"label": "Battle event feed", "detail": f"Feature built and live. Live: {event_count} public battle event(s) on arena, profiles and news surfaces.", "status": "done"},
                {"label": "Chef profile battle record", "detail": f"Feature built and live. Live: {profile_count} chef battle profile(s) with rank, rating, wins, losses, refusals and moves.", "status": "done"},
                {"label": "Homepage battle block", "detail": "Homepage battle block live behind CHEF_BATTLE_ENABLED.", "status": "done"},
                {"label": "Newsfeed integration", "detail": "Challenge, refusal, battle start, submission and completion events create site news entries.", "status": "done"},
