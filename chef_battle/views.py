    ...
    phases = [
        ...
        },
        {
            ...
            "items": [
                ...
                {"label": "Clan / team battles", "detail": "SEASON 2, by the Owner's ruling of 2026-07-14 restated 2026-08-17. clans_alliances_rules.md section 2: Season 1 carries the alliance entity, the clan-alliance link and the call-an-ally hook only; the full cuisine-vs-cuisine mechanic is Season 2. With allies a fight becomes a battle OF A CUISINE rather than of a single recipe - a different format, not an extension of the 1v1 duel, which is hard-wired to challenger/opponent with a database constraint. Of the Season-1 three, the entity and the link exist; the call-an-ally hook does not and is unassigned.", "status": "pending"},
