    ...
    phases = [
        ...
        },
        {
            ...
            "items": [
                ...
                {"label": "Season leaderboard podium graphic", "detail": "Podium (1st / 2nd / 3rd) illustration for the season leaderboard top-three block, matching arena visual style.", "status": "todo"},
                {"label": "Hall of Fame banner", "detail": "Wide decorative banner for the Hall of Fame page header. Stone or wood textures, trophy imagery, Celtic motif optional.", "status": "todo"},
                {"label": "Token shop visual assets", "detail": "Coin/token icon and package artwork (Starter / Contender / Warrior / Champion / Legend packs) for the token shop page.", "status": "todo"},
