...
urlpatterns = [
    ...
    path("arena/chat/dm/open/", views.arena_chat_open_dm, name="arena_chat_open_dm"),
    path("arena/chat/dm/list/", views.arena_chat_conversations,
    ...
    path("arena/chat/poll/vote/", views.arena_chat_poll_vote,
         name="arena_chat_poll_vote"),
    path("arena/chat/chef/<slug:slug>/", views.arena_chat_profile,
         name="arena_chat_profile"),
