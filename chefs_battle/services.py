...
ROADMAP_MILESTONES: list[tuple[str, str, bool, bool]] = [
    ...
    ("Register all models in Django Admin",                          "Phase 0: Architecture",  True,  False),
    ("Admin actions: cancel / dispute / force-reveal / force-complete", "Phase 0: Architecture", True, False),
    ("Create selectors.py for read queries",                        "Phase 0: Architecture",  True,  False),
    ("Split services.py into separate modules",                     "Phase 0: Architecture",  True,  False),
    ...
    ("No-show / late submission handling",                           "Phase 1: MVP Core",      True,  False),
    ...
    ("Management command: auto-expire stale challenges",             "Phase 1: MVP Core",      True,  False),
    ...
    ("Permission tests: anon / non-participant / hidden entries",    "Phase 1: Tests",         True,  True),
    ("Anti-abuse tests: duplicate vote / self-vote / farm pair",     "Phase 1: Tests",         True,  True),
