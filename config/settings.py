...
MIDDLEWARE = [
    ...
    "accounts.middleware.OwnerTimedBlockMiddleware",
...
PWA_CACHE_VERSION = os.getenv("PWA_CACHE_VERSION", "culineire-pwa-v7")
STORAGES = {
...
STRIPE_PRICE_MODE = os.getenv("STRIPE_PRICE_MODE", "test" if not IS_PRODUCTION else "live")
BEARCAVE_VAT_NUMBER = os.getenv("BEARCAVE_VAT_NUMBER", "IE3645402WH")
SPONSOR_ADMIN_EMAIL = os.getenv("SPONSOR_ADMIN_EMAIL", "culineire@bearcave.ie")
