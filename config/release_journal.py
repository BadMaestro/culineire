RELEASE_JOURNAL = [
    ...
    },
    {
        ...
        "date": "2026-07-24",
        "commit": "d0980993",
        "title": "ArenaFront af22: softer ceiling vignette for wall-wash blend (renumbered)",
        "section": "Chef Battles / Deployment",
        "summary": "Owner no-idle: lighten top ceiling vignette so af14 wall-wash gold bloom blends more cleanly. Renumbered from 2.5.490 after Cursor claimed 2.5.485 for af15+af16 (#2287). Dual-cursor standby respected. SVG centre mask held. Cache-bust af22. Fence: polish untouched. Rollback: revert and redeploy. [Authored by ArenaFront.]",
    },
    {
        "version": "2.5.490",
        "date": "2026-07-24",
        "commit": "600cc819",
        "title": "ArenaFront af21: stronger green/red side atmosphere (renumbered)",
        "section": "Chef Battles / Deployment",
        "summary": "Owner no-idle: deepen challenger green / opponent red side washes with --hall-green/--hall-red. Renumbered from 2.5.489 after #2287. Dual-cursor standby respected. SVG centre mask held. Cache-bust af21. Fence: polish untouched. Rollback: revert and redeploy. [Authored by ArenaFront.]",
    },
    {
        "version": "2.5.489",
        "date": "2026-07-24",
        "commit": "0012d7f5",
        "title": "ArenaFront af20: soft parchment warm rim (outer only) (renumbered)",
        "section": "Chef Battles / Deployment",
        "summary": "Owner no-idle: add outer parchment warm rim on .page--arena::after using --surface tokens; centre mask still clears SVG seats. Renumbered from 2.5.488 after #2287. Dual-cursor standby respected. Cache-bust af20. Fence: polish untouched. Rollback: revert and redeploy. [Authored by ArenaFront.]",
    },
    {
        "version": "2.5.488",
        "date": "2026-07-24",
        "commit": "ef756fe8",
        "title": "ArenaFront af19: mobile hall readability + wider SVG-clear mask (renumbered)",
        "section": "Chef Battles / Deployment",
        "summary": "Owner no-idle: on <=900px raise ::before opacity and widen ::after centre mask so live SVG seats stay clear on mobile while hall atmosphere still reads. Renumbered from 2.5.487 after #2287. Dual-cursor standby respected. Cache-bust af19. Fence: polish untouched. Rollback: revert and redeploy. [Authored by ArenaFront.]",
    },
    {
        "version": "2.5.487",
        "date": "2026-07-24",
        "commit": "806f13aa",
        "title": "ArenaFront af18: brighter stand gold lines (renumbered)",
        "section": "Chef Battles / Deployment",
        "summary": "Owner no-idle: brighter left/right stand gold rails in .page--arena::before with --hall-gold. Renumbered from 2.5.486 after #2287. Dual-cursor standby respected. SVG centre mask held. Cache-bust af18. Fence: polish untouched. Rollback: revert and redeploy. [Authored by ArenaFront.]",
    },
    {
        "version": "2.5.486",
        "date": "2026-07-24",
        "commit": "a1362608",
        "title": "ArenaFront af17: warmer gold bloom for wall-wash match (renumbered)",
        "section": "Chef Battles / Deployment",
        "summary": "Owner no-idle + af14 live: warmer upper gold bloom using --hall-gold/--hall-gold-light. Renumbered from 2.5.485 after Cursor claimed 485 for af15+af16 (#2287); Cursor plans af17 as 486. Dual-cursor standby respected. SVG centre mask held. Cache-bust af17. Fence: polish untouched. Rollback: revert and redeploy. [Authored by ArenaFront.]",
    },
    {
        "version": "2.5.484",
        "date": "2026-07-24",
    ...
    },
    {
        ...
        "date": "2026-07-24",
        "commit": "a2e97a39",
        "title": "ArenaFront af8: denser side gold dust + stand gold lines (was 475; renumbered)",
        "section": "Chef Battles / Deployment",
        "summary": "Owner no-idle (#2201): denser cinematic gold dust on left/right stands and brighter stand gold lines in .page--arena::before using official --hall-gold tokens only. af6 SVG centre mask and af7 token-only page fill unchanged. Cache-bust af8. Renumbered from 2.5.475 after Cursor claimed 2.5.474 for af6 deploy (#2221). Fence: polish untouched. Rollback: revert and redeploy. [Authored by ArenaFront.]",
    },
    {
        "version": "2.5.475",
        "date": "2026-07-24",
        "commit": "dab856e0",
        "title": "ArenaFront af7: token-only hall deepen + no raw HEX (was 474; renumbered)",
        "section": "Chef Battles / Deployment",
        "summary": "Follow-up to af5 deploy note (#2214): drop raw HEX fallback on .page--arena background-color; use var(--hall-dark-0, var(--ink)) only. Deepen upper gold bloom and green/red side washes with official --hall-* tokens; SVG centre mask from af6 unchanged. Cache-bust af7. Renumbered from 2.5.474 after Cursor claimed 2.5.474 for af6 live deploy (#2221). Fence: polish untouched. Rollback: revert and redeploy. [Authored by ArenaFront.]",
    },
    {
        "version": "2.5.472",
        "date": "2026-07-24",
